...
class TestDishDNSReaconAPI:
    ...
    @patch('dishdns_reacon.api.general_enum')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.brute_domain')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.brute_reverse')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.check_wildcard')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.brute_srv')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.brute_tlds')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.lib.dnshelper.DnsHelper.zone_transfer')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.lib.dnshelper.DnsHelper.get_caa')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.in_cache')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.ds_zone_walk')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.check_bindversion')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.check_recursive')
    @patch('dishdns_reacon.api.DnsHelper')
    ...
    @patch('dishdns_reacon.api.check_nxdomain_hijack')
